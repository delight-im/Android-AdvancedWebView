...
public class AdvancedWebView extends LollipopFixedWebView {
    public static boolean isFileUrl(String inputStr) {
        String regex = "(?:([^:/?#]+):)?(?://([^/?#]*))?([^?#]*\\.(?:xls|doc|docx|xlsx|ppt|pptx))(?:\\?([^#]*))?(?:#(.*))?";
        return Pattern.compile(regex).matcher(inputStr.toLowerCase()).matches();
    }

    public static boolean isSpreadSheets(String mimeType) {
        String csvMime = "text/comma-separated-values";
        String odsMime = "application/vnd.oasis.opendocument.spreadsheet";
        String xlsMime = "application/vnd.ms-excel";
        String xlsxMime = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
        return mimeType.equals(csvMime)
                || mimeType.equals(odsMime)
                || mimeType.equals(xlsMime)
                || mimeType.equals(xlsxMime);

    }
    public static boolean isDocs(String mimeType) {
        String csvMime = "application/msword";
        String odsMime = "application/vnd.openxmlformats-officedocument.wordprocessingml.document";
        String xlsMime = "application/vnd.openxmlformats-officedocument.wordprocessingml.template";
        return mimeType.equals(csvMime)
                || mimeType.equals(odsMime)
                || mimeType.equals(xlsMime);
...
//			}
        ...
        super.setWebChromeClient(new WebChromeClient() {
            ...
            public void onReceivedTitle(WebView view, String title) {
                if (mListener != null) mListener.onReceivedTitle(title);
                if (mCustomWebChromeClient != null) {
            ...
            public void onReceivedIcon(WebView view, Bitmap icon) {
                if (mListener != null) mListener.onReceivedIcon(icon);
                if (mCustomWebChromeClient != null) {
